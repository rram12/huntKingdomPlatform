...
public class Reparation {
    ...
    public String toString() {
        return "Reparation{" + "id=" + id + ", dateDebut=" + dateDebut+ ", dateFin=" + dateFin + ", prixRep=" + prixRep + ", description=" + description + ", userId=" + userId + ", Piecesdefectueuses_id=" + Piecesdefectueuses_id + '}';
    }
