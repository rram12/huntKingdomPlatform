 ...
 * @author User
 */
public class ModifyPublicity extends Form {
    String path = null;
    public ModifyPublicity(Publicity P,Resources res){
        ...
        TextField tPrice= new TextField(Float.toString(P.getPrix()), "price");
        Label descript = new Label("Description");
        TextField tDescription= new TextField(P.getDescription(), "description");
        Label company = new Label("Company");
        TextField tCompagnie= new TextField(P.getCompagnie(), "Company");
        Label title = new Label("Title");
        TextField tTitre= new TextField(P.getTitre(), "Title");
        ...
        TextField tImage= new TextField(P.getImage(), "Image");
             ...
             if (validateFields(tTitre, tPrice, tCompagnie,tDescription, tfArrival, tEnd))
                {
                    try {
                        Publicity p;
                        p = new Publicity(P.getId(),tfArrival.getDate(),tEnd.getDate(),tCompagnie.getText(),tTitre.getText(),Float.parseFloat(tPrice.getText()),tDescription.getText(),path);
                        System.out.println(p);
                        if( PubliciteService.getInstance().modifyPublicity(p))
                            Dialog.show("Success","Publicity successfully modified",new Command("OK"));
                        else
