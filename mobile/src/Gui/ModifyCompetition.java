 ...
 * @author User
 */
public class ModifyCompetition extends BaseForm{
    ...
    public ModifyCompetition(Competition P,Resources res){
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                 if (validateFields(tNom, tParticipant, tLieu, tfArrival, tEnd))
                {
                    try {
                        Competition p;
                        p = new Competition(P.getId(),Categorie.getSelectedItem(),tNom.getText(),tLieu.getText(),Integer.parseInt(tParticipant.getText()),tfArrival.getDate(),tEnd.getDate());
                        System.out.println(p);
                        if( CompetitionService.getInstance().modifyCompetition(p))
                            Dialog.show("Success","Competition successfully modified",new Command("OK"));
                        else
    ...
    private boolean validateFields(TextField nomm,TextField participants, TextField lieu, Picker debutePicker,Picker endPicker) {
