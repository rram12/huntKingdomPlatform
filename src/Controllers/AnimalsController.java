...
@FXML
    ...
    public void afficher(List<Animal> animals){
        for (int i = 0; i < animals.size(); i++) {
            ...
            ImageView img = new ImageView(new Image("file:/C:/Users/tibh/Desktop/Pidev2020/copieJava/copie10/HuntKingdom/src/Uploads/"+animals.get(i).getImage_animal()));
            ...
            lnom.setLayoutX(14);
            lnom.setLayoutY(191);
            lnom.setPrefWidth(32);
            lnom.setPrefHeight(17);
            lnom.setTextFill(Color.BLACK);
            ...
            fromto.setTextFill(Color.BLACK);
