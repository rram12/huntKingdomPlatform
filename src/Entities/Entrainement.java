...
public class Entrainement {
    ...
    public Entrainement(int id, String categorie, int nbHeures, String dateEnt, Double prix, String lieu, int userId, int entraineurId, int animalId, int produitId, String accepter) {
        this.id = id;
    ...
    public Entrainement(String categorie, int nbHeures, Double prix, String lieu, int animalId, int produitId) {
        this.categorie = categorie;
        this.nbHeures = nbHeures;
        this.prix = prix;
        this.lieu = lieu;
    ...
    public Entrainement(String categorie, int nbHeures,String dateEnt, Double prix, String lieu,int userId,int animalId,int produitId,String accepter) {
        this.categorie = categorie;
        this.nbHeures = nbHeures;
        this.dateEnt=dateEnt;
        this.prix = prix;
